...
class PasienManager {
  public:
    ...
    void hitungJanjiPerDokter();
    void displayMenuJanji();
    void tampilkanJanjiBerdasarkanWaktuSlot();
...
public:
    ...
    void displayMenu() {
        ...
        do {
            ...
            cout << "| $$  | $$| $$\\  $$$   | $$   | $$  \\ $$  | $$  | $$  | $$| $$\\  $$$" << endl;
            cout << "| $$  | $$| $$ \\  $$   | $$   | $$  | $$ /$$$$$$| $$  | $$| $$ \\  $$" << endl;
            cout << "|__/  |__/|__/  \\__/   |__/   |__/  |__/|______/|__/  |__/|__/  \\__/" << endl;
            cout << " /$$$$$$$   /$$$$$$  /$$   /$$ /$$$$$$$$ /$$$$$$$$ /$$$$$$$" << endl;
            ...
            cout << "| $$  | $$| $$  | $$| $$\\  $$    | $$   | $$      | $$  \\ $$" << endl;
            cout << "| $$$$$$$/|  $$$$$$/| $$ \\  $$   | $$   | $$$$$$$$| $$  | $$" << endl;
            cout << "|_______/  \\______/ |__/  \\__/   |__/   |________/|__/  |__/" << endl;
...
void Login::menu_pasien(){
    ...
    cout << "===========================================================================================================" << endl;
    cout << "+================== Menu Pasien ==================+\n";
    cout << "| 1. Lihat Data Pribadi Pasien" << setw(22) << "|\n";
    cout << "| 2. Tampilkan Akun Berdasarkan" << setw(21) << "|\n";
    cout << "| 3. Janji Temu dengan Dokter" << setw(23) << "|\n";
    cout << "| 4. Lihat Pesan Dokter" << setw(29) << "|\n";
    cout << "| 5. Menu Antrian Dokter" << setw(28) << "|\n";
    cout << "| 6. Pengaturan Akun" << setw(32) << "|\n";
    cout << "| 7. Kuisioner" << setw(38) << "|\n";
    cout << "| 8. Pengaduan" << setw(38) << "|\n";
    cout << "| 9. Survey" << setw(41) << "|\n";
    cout << "| 10. Edukasi" << setw(39) << "|\n";
    cout << "| 11. Lihat Pemantauan Lingkungan Rumah Sakit" << setw(7) << "|\n";
    cout << "| 12. Keluar dari Akun" << setw(30) << "|\n";
    cout << "+=================================================+\n";
    cout << "Pilihan Anda: ";
    ...
    case 3:
        while (true)
        {
            ...
            cout << "3. Tampilkan Jumlah Janji dengan Dokter" << endl;
            cout << "4. Tampilkan Janji Temu Berdasarkan Slot" << endl;
            cout << "5. Ubah Jadwal Temu dengan Dokter\n";
            ...
            case 2:
                ...
                break;
            case 3:
                pasienManager.hitungJanjiPerDokter();
                break;
            case 4:
                pasienManager.tampilkanJanjiBerdasarkanWaktuSlot();
            break;
...
void PasienManager::hitungJanjiPerDokter() {
        vector<string> dokter;
        vector<int> count;
        ...
        if (file.is_open()) {
            ...
            while (getline(file, line)) {
                ...
                if (pos != string::npos) {
                    string namaDokter = line.substr(0, pos);

                    auto it = find(dokter.begin(), dokter.end(), namaDokter);
                    if (it != dokter.end()) {
                        int index = distance(dokter.begin(), it);
                        count[index]++;
                    } else {
                        dokter.push_back(namaDokter);
                        count.push_back(1);
                    }
                }
            }
            ...
            if (!dokter.empty()) {
                cout << "Jumlah Janji per Dokter:" << endl;
                for (size_t i = 0; i < dokter.size(); ++i) {
                    cout << dokter[i] << ": " << count[i] << " janji" << endl;
                }
            } else {
                cout << "Belum ada janji terdaftar." << endl;
            }
        } else {
...
void PasienManager::displayMenuJanji() {
    cout << "Masukkan waktu slot yang ingin dicari (contoh: 'Senin 10:00 AM'): ";
}

void PasienManager::tampilkanJanjiBerdasarkanWaktuSlot() {
    string waktuSlot;
    displayMenuJanji();
    cin.ignore();
    getline(cin, waktuSlot);
    ...
    if (file.is_open()) {
        ...
        while (getline(file, line)) {
            ...
            if (pos != string::npos) {
                Janji janji;
                janji.dokter = line.substr(0, pos);
                janji.slot = line.substr(pos + 1);
                janjiDokter.push_back(janji);
            }
        }
        ...
        if (!janjiDokter.empty()) {
            vector<Janji> janjiDipilih;
            for (const Janji &janji : janjiDokter) {
                if (janji.slot == waktuSlot) {
                    janjiDipilih.push_back(janji);
                }
            }

            if (!janjiDipilih.empty()) {
                cout << "Janji pada Waktu Slot '" << waktuSlot << "':" << endl;
                for (const Janji &janji : janjiDipilih) {
                    cout << "Dokter: " << janji.dokter << ", Slot: " << janji.slot << endl;
                }
            } else {
                cout << "Tidak ada janji pada waktu slot tersebut." << endl;
            }
        } else {
            cout << "Belum ada janji terdaftar." << endl;
        }
